...
def CrossVal():
    print("5 fold cross validation with model morpho_patch...")
    ...
    for k in range(5):
        ...
        np.save(str(project_paths.MODELS_PATH / "morpho_patch" / "morpho_{}.npy".format(k)), predicted)
        np.save(str(project_paths.MODELS_PATH / "morpho_patch" / "morpho_post_{}.npy".format(k)), predicted_post)
        np.save(str(project_paths.MODELS_PATH / "morpho_patch" / "morpho_tta_{}.npy".format(k)), predicted)
        np.save(str(project_paths.MODELS_PATH / "morpho_patch" / "morpho_tta_post_{}.npy".format(k)), predicted_post)
        np.save(str(project_paths.MODELS_PATH / "morpho_patch" / "truth_{}.npy".format(k)), groundtruth)
